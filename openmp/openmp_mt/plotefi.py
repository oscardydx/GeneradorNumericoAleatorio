...
plt.plot(nThreads, np.full_like(nThreads, 0.985962), color='blue', label='0.985962')  # Línea azul en 0.6
...
plt.title('RNG MT Maquina con 8-Cores/16-Threads', fontsize=10)
